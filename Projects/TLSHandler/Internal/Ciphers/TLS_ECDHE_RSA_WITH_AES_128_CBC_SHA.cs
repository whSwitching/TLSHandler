...
{
    class TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA : Suite12<KeyExchange.EcdheKeyExchange, BulkEncryption.Aes128_CBC, HMACSHA1>
    {
        public override Enums.CipherSuite CipherSuite => Enums.CipherSuite.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA;
