...
namespace TLSHandler.Internal.TLS.Extensions
{
    ...
    {
        public override ExtensionType Type { get { return ExtensionType.SIGNATURE_ALGORITHMS_CERT; } }
        ...
        public SignatureAlgorithmsCert(byte[] extensionBytes) : base(extensionBytes)
        {
